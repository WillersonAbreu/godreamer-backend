...
<div style="margin-top: 90px;" class="container-fluid ">
		...
		<div  class="container col-md-8" style="margin-left: 20px;">			   	
			<form  id="form-usu" name="form-usu" method="POST" action="cadastrese/salvar" style="margin-top: 10px;">					
				...
				<div class="row" style="margin-top: 5px;">
					<div class="col ">
						<label><input  value="1" type="radio" name="optradio">Usuário comum</label>
					</div>

					<div class="col">
						<label><input value="2" type="radio" name="optradio">Psicólogo/Estudante</label>
					</div>
				</div>
	...
	@endsection
=======
@extends('templates.templatebasico') @section('formlogin')
<form name="form-button" method="get" action="http://127.0.0.1:8000">
    <button class="btn btn-outline-info" type="submit">Voltar</button>
</form>
    ...
    <div class="row">
        <div class="container col-md-8" style="margin-left: 20px;">
            <form
                ...
                name="form-usu"
                method="POST"
                action="cadastrese/salvar"
                style="margin-top: 10px;"
            >
                @method('PUT') @csrf @if(session()->has('successo'))
                <div class="alert alert-success">
                    {{ session()->get('successo') }}
                </div>
                @endif @if(session()->has('falha'))
                <div
                    class="alert alert-danger alert-dismissible fade show"
                    role="alert"
                >
                    <strong>{{ $errors->first('falha') }}</strong>
                    <button
                        type="button"
                        class="close"
                        data-dismiss="alert"
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <input
                            name="nome"
                            class="form-control mr-sm-2 inputs {{ $errors->has('nome') ? 'is-invalid' : '' }}"
                            type="text"
                            placeholder="Nome"
                            aria-label="Nome"
                        />
                ...
                <div class="row">
                    ...
                    <div class="col" style="margin-top: 5px;">
                        <input
                            maxlength="8"
                            name="senha"
                            class="form-control mr-sm-2 inputs {{ $errors->has('senha') ? 'is-invalid' : '' }}"
                            type="password"
                            placeholder="Senha"
                            aria-label="Senha"
                        />
                ...
                <div class="row">
                    ...
                    <div class="col" style="margin-top: 5px;">
                        <input
                            name="endereco"
                            class="form-control mr-sm-2 inputs {{ $errors->has('endereco') ? 'is-invalid' : '' }}"
                            type="text"
                ...
                <div class="row">
                    ...
                    <div class="col" style="margin-top: 5px;">
                        <input
                            ...
                            id="celular"
                            name="celular"
                            class="form-control mr-sm-2 inputs {{ $errors->has('celular') ? 'is-invalid' : '' }}"
                            type="text"
                            placeholder="Celular"
                            aria-label="Celular"
                        />
                ...
                <div class="row">
                    ...
                    <div class="col" style="margin-top: 5px;">
                        <input
                            ...
                            id="data-nasc"
                            name="data_nasc"
                            class="form-control mr-sm-2 inputs {{ $errors->has('data_nasc') ? 'is-invalid' : '' }}"
                            type="text"
                ...
                <div class="row" style="margin-bottom: 100px;">
                    <button
                        type="submit"
                        class="btn btn-success btn-cadastre-se"
                    >
                        Cadastrar
                    </button>
                </div>
